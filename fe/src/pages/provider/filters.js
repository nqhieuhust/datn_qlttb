			...
			<div className="row mb-4">
				<div className="col-md-4 mb-2 form-group">
					<Form.Group>
						...
						<Input className="form-control" value={ form.provider_name } placeholder="Nhập tên nhà cung cấp" onChange={ ( e ) => setField( form, 'provider_name', e.target.value, setForm ) } />
				...
				<div className="col-md-4 mb-2 form-group">
					<Form.Group>
						...
						<Input className="form-control" value={ form.mobile } placeholder="Nhập số điện thoại" onChange={ ( e ) => setField( form, 'mobile', e.target.value, setForm ) } />
